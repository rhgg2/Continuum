...
1. The octave column takes a negative octave: `-` negates the octave under
...
2. A shift-held digit overwrites one place of the octave field and stays
...
3. Rewrite `docs/tuning.md` § Coordinate systems and § Addressable range
