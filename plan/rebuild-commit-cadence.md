...
3. **Phase 3 — comment corrections** (§ But the parallel threading is
   ...
   2026-07-29, the clipped case cannot carry E3.  ← done
...
- 2026-07-30 tm: deferred's commit comment corrected — the nest absorbs the sort; the in-place clip of an unrealised spec is the reason (§ D4)
- 2026-07-30 tm: mmBatch's lazy-add door retired — callerless after the eager add; closes phase 2
...
(empty — all three phases have landed and the programme is done; run
/plan-close.)

## Queued (current phase; one-liners)

(empty — nothing left to size.)
