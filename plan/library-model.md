...
(empty — phase 3 landed with the libPicker badge; phase 4 (editors write to project, § 4) is next. Run /plan-next to promote its first commit.)

## Queued (current phase; one-liners)

(empty — phase 4 is now in-flight. Run /plan-next to seed this queue from § 4.)
