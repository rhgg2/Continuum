...
3. **Phase 3 — patches** (§ The chain surface) — named chains in a tiered `fxPatches` catalogue, stamped by copy from the fx tab's action row — deferred past Phase 4 (2026-08-04), taken up 2026-08-07  ← in flight
