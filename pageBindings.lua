...
pageBindings.tracker = {
  ...
  prevTake               = { {ImGui.Key_Comma,    ImGui.Mod_Alt} },
  nextTake               = { {ImGui.Key_Period,  ImGui.Mod_Alt} },
  prevInstance           = { {ImGui.Key_UpArrow,   ImGui.Mod_Alt} },
  nextInstance           = { {ImGui.Key_DownArrow, ImGui.Mod_Alt} },
  ...
  pageUp                 = { ImGui.Key_PageUp, {ImGui.Key_V, ImGui.Mod_Shift, ImGui.Mod_Super} },
  pageDown               = { ImGui.Key_PageDown, {ImGui.Key_V, ImGui.Mod_Super} },
  colLeft                = { {ImGui.Key_Tab, ImGui.Mod_Shift} },
  colRight               = { ImGui.Key_Tab },
  channelLeft            = { {ImGui.Key_B, ImGui.Mod_Ctrl} },
  channelRight           = { {ImGui.Key_F, ImGui.Mod_Ctrl} },
  noteOff                = { ImGui.Key_1 },
  ...
  addNoteLane            = { {ImGui.Key_RightArrow, ImGui.Mod_Ctrl} },
  addTypedCol            = { {ImGui.Key_RightArrow, ImGui.Mod_Ctrl, ImGui.Mod_Shift} },
  ...
  cycleBlock             = { {ImGui.Key_O,          ImGui.Mod_Super} },
  cycleVBlock            = { {ImGui.Key_Space,      ImGui.Mod_Super} },
  ...
  incRPB                 = { {ImGui.Key_Equal, ImGui.Mod_Super, ImGui.Mod_Shift} },
  decRPB                 = { {ImGui.Key_Minus, ImGui.Mod_Super, ImGui.Mod_Shift} },
  setRPB                 = { {ImGui.Key_Z,     ImGui.Mod_Super} },
  takeProperties         = { {ImGui.Key_P, ImGui.Mod_Alt} },
  newTakeBelow           = { {ImGui.Key_Enter, ImGui.Mod_Alt} },
  duplicateBelow         = { {ImGui.Key_DownArrow, ImGui.Mod_Alt, ImGui.Mod_Shift} },
  deleteInstance         = { {ImGui.Key_UpArrow,   ImGui.Mod_Alt, ImGui.Mod_Shift} },
...
local arrange = {
  ...
  arrangeNextDrop               = { ImGui.Key_Tab },
  arrangePrevDrop               = { { ImGui.Key_Tab,        ImGui.Mod_Shift } },
