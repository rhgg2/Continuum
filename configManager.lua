...
local declarations = {
  ...
  { 'colour.tracker.cutRow',      'colour.tracker.inactive' },  -- the rendered span ends here; the rows below are drawn, not heard
  ...
  { 'colour.chrome.toolbar.meter.bg',    {'base.zone7', 0.3} },  -- master meter trough
  ...
  { 'colour.chrome.toolbar.popupBorder',  'base.zone7'         },  -- 1px rule; reads on both popup fills, zone10 here and editor.bg in a modal
