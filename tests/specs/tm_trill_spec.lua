...
return {
...

  {
    ...
    run = function(harness)
      ...
      local host = require('harness').parkedNotes(h.tm, 1)[1]
...

  {
    ...
    run = function(harness)
      ...
      local sounded = {}
      for i, n in ipairs(fxNotesOf(h.fm:dump(), require('harness').parkedNotes(h.tm, 1)[1].uuid)) do
      ...
      h.tm:assignParked(require('harness').parkedNotes(h.tm, 1)[1], { intentCents = 6100 })
      h.tm:flush()

      local fns = fxNotesOf(h.fm:dump(), require('harness').parkedNotes(h.tm, 1)[1].uuid)
      t.deepEq({ fns[1].intentCents, fns[2].intentCents, fns[3].intentCents, fns[4].intentCents },
        { 6100, 6300, 6100, 6300 },
